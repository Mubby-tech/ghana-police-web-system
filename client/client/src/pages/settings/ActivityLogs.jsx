...
function ActivityLogs() {
  ...
  const fetchLogs = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:5000/api/settings/activity-logs?${queryParams}`, {
        method: 'GET',
        headers: {
  ...
  const fetchStats = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:5000/api/settings/activity-stats?${queryParams}`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const handleExport = async (format = 'json') => {
    try {
      ...
      const response = await fetch(`http://localhost:5000/api/settings/activity-logs/export?${queryParams}`, {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`
        }
